...
<body>
   ...
   <aside class="sidenav hidden-sm hidden-md" id="nav">
       <div class="list">
        ...
        <a href="#" class="active"><i class="fa fa-check"></i> TEST +</a>
      ...
      <div class="grid">
        <div class="painel">
            <div class="painel-header">
                <h4 class="painel-title">Tests Tasks</h4>
                ...
                <div class="modal" id="modal">
                  <div class="container">
                    ...
                    <form id="form" class="form">
                        ...
                        <div class="form-control">
                            <label for="subject">考試內容</label>
                            <input type="quest"  id="quest" autofocus placeholder="TEST"/>
                            <i class="fas fa-check-circle"></i>
                            <i class="fas fa-exclamation-circle"></i>
                            <small>Error message</small>
                        </div>
            ...
            <div class="painel-body">
                <div class="alert alert-success">幸運女神降靈!</div>
                <table class="zebra">
                    <tr>
                        <th>科目</th>
                        <th>任務</th>
